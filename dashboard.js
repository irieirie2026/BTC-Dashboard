    ...
    children: {
      ...
      "prediction-markets": {
        ...
        onShow: () => {
          ...
          window.decorateHelpLabels?.(
            document.querySelector('#dashboard-market .menu-screen[data-l2="prediction-markets"]'),
          );
        },
      },
    },
      ...
      stocks: {
        ...
        children: {
          globalInsights: {
            ...
            accent: "#64748b",
            accentDim: "rgba(100, 116, 139, 0.18)",
            onShow: () => window.loadEquityGlobal?.(),
          },
          companyInsights: {
            label: "Company Insights",
            accent: "#64748b",
            accentDim: "rgba(100, 116, 139, 0.18)",
            onShow: () => window.loadEquityCompany?.(),
          },
        },
      },
      futures: {
      ...
      strategies: {
        ...
        children: {
          overview: {
            ...
            accent: "#c084fc",
            accentDim: "rgba(192, 132, 252, 0.18)",
            onShow: () => window.loadDefiSection?.("strategies"),
          },
        },
      },
      wrapped: {
      ...
      borrowing: {
        ...
        children: {
          overview: {
            ...
            accent: "#6366f1",
            accentDim: "rgba(99, 102, 241, 0.18)",
            onShow: () => window.loadDefiSection?.("borrowing"),
          },
        },
      },
      liquidity: {
...
const DASHBOARD_META = {
  ...
  defi: {
    title: "Bitcoin DeFi",
    subtitle: "Strategies · Wrapped BTC · Bridges · Lending",
